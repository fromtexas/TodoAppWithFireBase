    ...
    return (
      <div className='edit-todo-form'>
        <form onSubmit={this.edit.bind(this)}>
          <input defaultValue={text}  placeholder='Add somthing' type='text' ref='todo'/>
          <button className='button expanded custom-margin'><i className='ion-android-done-all'></i> Save</button>
        </form>
      </div>
    )
  }
